...
affected_entities = {
    {"el_solar", "solar-panel", "solar-panel"},
    {"fi_crafter", "assembling-machine-3", "assembling-machine"},
    {"gr_crafter", "assembling-machine-3", "assembling-machine"},
}
...
--set next upgrades
data.raw['assembling-machine']['fi_crafter'].next_upgrade = 'gr_crafter'
data.raw['assembling-machine']['assembling-machine-3'].next_upgrade = 'fi_crafter'
data.raw["solar-panel"]["solar-panel"].next_upgrade = "el_solar"
