...
data:extend({
    ...
    --stelerator fusion
    {
        ...
        categories = {'fu_stelar_reactor_crafting_category'},
        enabled = false,
        ingredients = {
    ...
    --tokamak fusion
    {
        ...
        type = 'recipe',
        localised_name = {"fluid-name.fu_lead_fluid_hot"},
        categories = {'fu_tokamak_reactor_crafting_category'},
        enabled = false,
        ingredients = {
    ...
    },
    {
        ...
        categories = {'fu_activator_crafting_category'},
    ...
    --heating
    {
        ...
        categories = {'fu_star_engine_heater_crafting_category'},
        enabled = false,
    ...
    },
    {
        ...
        results = {
            ...
            {type="item", name="fu_stone", amount=1, independent_probability=0.25},
    ...
    },
    {
        ...
        results = {
            {type="fluid", name="fu_hydrogen", amount=10},
            {type="fluid", name="fu_oxygen", amount=5},
            {type="item", name="fi_gold", amount=1, independent_probability=0.50},
        },
        energy_required = 5,
        always_show_made_in = true,
        icon_size = 64,
    ...
    },
    {
        ...
        results = {
            {type="fluid", name="fu_hydrogen", amount=20},
            {type="fluid", name="fu_oxygen", amount=10},
            {type="item", name="fi_gold", amount=1, independent_probability=0.75},
        },
        energy_required = 5,
        always_show_made_in = true,
        icon_size = 64,
    ...
    },
    {
        ...
        results = {
            ...
            {type="item", name="fu_slag", amount=1, independent_probability=0.25},
        },
